...
- (void)onResp:(BaseResp *)resp {
    if ([resp isKindOfClass:[SendMessageToWXResp class]]) {
        ...
        NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:strMsg,[NSString stringWithFormat:@"%d",resp.errCode], nil];
        
        [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_WXPAY_RESULT object:dict];
