...
+ (BOOL)twoDateIsSameDay:(NSDate *)first second:(NSDate *)second
{
	NSCalendar			*calendar			= [NSCalendar currentCalendar];
	int					unit				= NSMonthCalendarUnit | NSYearCalendarUnit | NSDayCalendarUnit;
	NSDateComponents	*fistComponets		= [calendar components:unit fromDate:first];
...
+ (NSString *)simpleStringFromTimestamp:(NSInteger)timestamp
{
    ...
    return [NSDate simpleStringFromDate:date];
}
...
+ (NSString *)shortStringFromTimestamp:(NSInteger)timestamp
{
    ...
    return [NSDate shortStringFromDate:date];
}
