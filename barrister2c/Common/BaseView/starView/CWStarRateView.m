...
#define FOREGROUND_STAR_IMAGE_NAME @"Appraisalstar2"//@"b27_icon_star_yellow"
#define BACKGROUND_STAR_IMAGE_NAME @"Appraisalstar1"//@"b27_icon_star_gray"
...
- (void)userTapRateView:(UITapGestureRecognizer *)gesture {
    ...
    int aNumber = offset / width;
    float tempOffset = offset - aNumber * width;

    CGFloat realStarScore = aNumber + (tempOffset > width/2.0?1:0.5);

    CGFloat starScore = self.allowIncompleteStar ? realStarScore : ceilf(realStarScore);
    //向下取整函数floor()和向上取整函数ceil()
